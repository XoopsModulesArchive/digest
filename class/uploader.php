<?php
// $Id: uploader.php,v 1.1.1.10 2004/11/20 15:18:19 phppp Exp $
//  ------------------------------------------------------------------------ //
...
class digest_uploader extends XoopsMediaUploader
{
    var $ext = "";
     ...
     * @param int $cmodvalue
     */
    function digest_uploader($uploadDir, $allowedMimeTypes = false, $maxFileSize = 0, $maxWidth = 0, $maxHeight = 0)
    {
